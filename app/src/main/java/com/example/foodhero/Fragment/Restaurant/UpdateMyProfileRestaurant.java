...
import com.example.foodhero.RestaurantGetInfoActivity;
import com.example.foodhero.RestuarantMain;
import com.example.foodhero.databinding.FragmentUpdateMyProfileRestaurantBinding;
...
public class UpdateMyProfileRestaurant extends Fragment {

    FragmentUpdateMyProfileRestaurantBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentUpdateMyProfileRestaurantBinding.inflate(LayoutInflater.from(getContext()),container,false);
        ...
        binding.updatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(path.length()>0){
                    ...
                    apiInterface.updateRestaurant(createPartFromString(preferences.getString("res_id","")),
                            ...
                            createFilePart("img",img)).enqueue(new Callback<GetRestaurantResponse>() {
                        @Override
        ...
        binding.updatepass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String conpassword=binding.conpass.getText().toString().trim();
                if(password.length()>0 && conpassword.length()>0 && password.equals(conpassword)){
                    apiInterface.changePasswordRestaurant(createPartFromString(preferences.getString("res_id","")),
